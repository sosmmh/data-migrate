...
// */
//public class DemoQuantityStartApplication {
//
...
//        sourceMap2.put(DataSourceUtil.URL, "jdbc:mysql://localhost:3306/test1?useSSL=false&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8");
//
//        new DemoQuantityMigrate(sourceMap, sourceMap).init();
//
//    }
//
//}
